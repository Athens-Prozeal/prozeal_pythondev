# Generated by Django 5.0.6 on 2024-09-23 20:15
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ...
        ('inspection', '0043_remove_plastering_comments'),
        migrations.swappable_dependency(settings.AUTH_USER_MODEL),
    ]

    operations = [
        migrations.RenameField(
            model_name='highvoltagepanel',
            old_name='comments',
            new_name='comments_or_remarks',
        ),
        migrations.RenameField(
            model_name='scadasystem',
            old_name='comments',
            new_name='comments_or_remarks',
        ),
        migrations.CreateModel(
            name='ACDistributionBoard',
            fields=[
