# Generated by Django 5.0.6 on 2024-09-03 21:05
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ...
        ('inspection', '0025_pourcardforcolumnconcrete_pourcardforslabconcrete'),
        migrations.swappable_dependency(settings.AUTH_USER_MODEL),
    ]

    operations = [
        migrations.CreateModel(
            name='PlainCementConcreteWork',
            fields=[
                ...
                ('grade_or_mix', models.CharField(max_length=155)),
                ('proportion_of_concrete', models.CharField(max_length=155)),
